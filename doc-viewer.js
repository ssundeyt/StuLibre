function downloadDoc(){
	...
	exportButton.textContent = 'Exportera till PDF';
	
	const instructionBox = newWindow.document.createElement('div');
	instructionBox.className = 'instruction-box';
	instructionBox.textContent = "Välj 'Save as PDF' i rullgardingsmenyn bredvid 'Destination' och klicka på den blåa 'Save'-knappen.";
...
function addButtons(){
	...
	distractionButton.textContent = "Slå på/av distraktionsfritt läge";
